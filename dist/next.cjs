...
function conFormato(texto, key) {
  ...
  while (m = RE.exec(texto)) {
    ...
    if (m[1] !== void 0) {
      ...
      nodos.push(
        src ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src, alt: m[1], style: S.msgImg }, k) : m[0]
      );
    } else if (m[3] !== void 0) {
      const href = urlSegura(m[4]);
      nodos.push(
        href ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href, target: "_blank", rel: "noopener noreferrer", style: S.mdLink, children: m[3] }, k) : m[0]
      );
    } else if (m[5] !== void 0) {
      nodos.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: m[5] }, k));
    } else if (m[6] !== void 0) {
      nodos.push(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { style: S.mdCode, children: m[6] }, k)
      );
    } else if (m[7] !== void 0) {
      nodos.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: m[7] }, k));
    } else if (m[8] !== void 0) {
      nodos.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: m[8] }, k));
    }
    ultimo = RE.lastIndex;
  }
...
function bloques(texto, keyBase) {
  ...
  const cerrarNormales = () => {
    ...
    salida.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: conFormato(normales.join("\n"), `${keyBase}-t${salida.length}`) }, `${keyBase}-t${salida.length}`)
    );
    normales = [];
  };
  const cerrarLista = () => {
    ...
    const Tag = tipo;
    salida.push(
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, { style: S.mdList, children: items.map((it, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: conFormato(it, `${keyBase}-l${salida.length}-${idx}`) }, idx)) }, `${keyBase}-l${salida.length}`)
    );
    lista = null;
  };
...
function AgentChat({
  ...
  const [apagado, setApagado] = (0, import_react.useState)(false);
  const [convId, setConvId] = (0, import_react.useState)(null);
  const [verHistorial, setVerHistorial] = (0, import_react.useState)(false);
  const [convs, setConvs] = (0, import_react.useState)(null);
  const [histError, setHistError] = (0, import_react.useState)(null);
  const claveConv = `agc-conv-${endpoint}`;
  const guardarConv = (0, import_react.useCallback)(
    (id) => {
      setConvId(id);
      try {
  ...
  const [vida, setVida] = (0, import_react.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `
      ...
      ` }),
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.panel, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.header, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.avatarSlot, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AgentOrb, { size: 38, accent: effAccent, mood }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.title, children: effTitle }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.subtitle, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: S.dot }),
            " ",
            subtitle
          ] })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            ...
            style: S.close,
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HistoryGlyph, { color: verHistorial ? effAccent : "#6b7085" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { "aria-label": "Cerrar", onClick: () => setOpen(false), style: S.close, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseGlyph, { color: "#6b7085" }) })
      ] }),
      verHistorial && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.histPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlusGlyph, { color: "#fff" }),
              "Nueva conversaci\xF3n"
            ]
          }
        ),
        convs === null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.histCargando, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AgentOrb, { size: 40, accent: effAccent, mood: "thinking" }),
          "Buscando tus conversaciones\u2026"
        ] }),
        (convs == null ? void 0 : convs.length) === 0 && !histError && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.histVacio, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AgentOrb, { size: 46, accent: effAccent, mood: "idle" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Todav\xEDa no hay nada guardado" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Cuando escribas, tus conversaciones quedar\xE1n aqu\xED para que puedas retomarlas cuando quieras." })
        ] }),
        histError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.histError, children: histError }),
        convs && convs.length > 0 && agruparPorFecha(convs).map((grupo) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.histGrupo, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.histGrupoTitulo, children: grupo.etiqueta }),
          grupo.items.map((c) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "button",
                    {
                      ...
                      style: S.histAbrir,
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: S.histTitulo, children: c.title }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: S.histMeta, children: [
                          actual && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "span",
                            {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                      ...
                      style: S.histBorrar,
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrashGlyph, {})
                    }
                  )
                ]
              },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...S.messages, ...verHistorial ? S.oculto : null }, children: [
        messages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.empty, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AgentOrb, { size: 54, accent: effAccent, mood }),
          "\xBFEn qu\xE9 te puedo ayudar?"
        ] }),
        messages.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...S.bubble,
            ...
            children: [
              m.suggestion && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...S.suggestionBadge, color: effAccent }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SparkGlyph, { color: effAccent }),
                " Sugerencia"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                MessageContent,
      ...
      image && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.imgPreviewRow, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: image, alt: "adjunto", style: S.imgPreview }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseGlyph, { color: "#6b7085" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: S.imgHint, children: "Imagen lista para enviar" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: send, style: S.form, children: [
        (allowImages || allowVoice && speechSupported) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.menuWrap, ref: menuRef, children: [
          allowImages && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              ref: fileRef,
              type: "file",
          ...
          menuOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.popupMenu, children: [
            allowImages && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", onClick: pickImage, style: S.menuItem, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AttachGlyph, { color: "#2a2c3a" }),
              " Adjuntar imagen"
            ] }),
            allowVoice && speechSupported && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", onClick: toggleListen, style: S.menuItem, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicGlyph, { color: "#2a2c3a" }),
              " Dictar por voz"
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: listening ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicGlyph, { pulsing: true, color: "#dc2626" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlusGlyph, { rotated: menuOpen, color: iconColor })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        (() => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SendGlyph, { color: inactivo ? "#a9adbe" : "#fff" })
            }
          );
        })()
      ] })
    ] }),
    !open && peek && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.peekWrap, role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.peekBubble, onClick: () => setOpen(true), children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...S.peekHead, color: effAccent }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SparkGlyph, { color: effAccent }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { flex: 1 }, children: effTitle }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              style: S.peekClose,
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseGlyph, { color: "#9296a8" })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.peekText, children: peek }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { ...S.peekCta, color: effAccent }, children: "Toca para responder" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.peekTail })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseGlyph, { color: "#fff" }) : (
            // Algo menor que el botón para que el halo no quede recortado.
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AgentOrb, { size: 52, accent: effAccent, mood })
          )
        }
      ),
...
function MessageContent({
  ...
  if (typeof content === "string") {
    if (!content) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TypingDots, {});
    if (role !== "assistant") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: content });
    const { texto, opciones } = separarSugerencias(content);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      bloques(texto, "m"),
      onQuickReply && opciones.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.quickReplies, children: opciones.map((op, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          type: "button",
...
function SettingsPanel({
  ...
  const [enabled, setEnabled_] = (0, import_react.useState)(true);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: S.settingsBackdrop, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: S.settingsCard, onClick: (e) => e.stopPropagation(), children: [
    ...
    cargando ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TypingDots, {}) : noDisponible ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: S.settingsHint, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: guardarConexion, style: S.settingsSection, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...S.settingsRow, marginBottom: 12, justifyContent: "space-between" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12.5, color: "#4b4f63" }, children: enabled ? "\u{1F7E2} Agente activo" : "\u26AA Agente apagado" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11.5, color: "#8b8fa3" }, children: "Se cambia fuera de aqu\xED" })
        ] }),
...
function HistoryGlyph({ color = "#4b4f63" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: "19", height: "19", viewBox: "0 0 24 24", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M3 4v4h4", stroke: color, strokeWidth: "2.1", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 7.5V12l3 1.8", stroke: color, strokeWidth: "2.1", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
}
function TrashGlyph() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "path",
    {
...
function SendGlyph({ color = "#fff" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M12 20V5", stroke: color, strokeWidth: "2.8", strokeLinecap: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
...
function AgentOrb({
  ...
  const [look, setLook] = (0, import_react.useState)({ x: 0, y: 0, dx: 0, dy: 0 });
  const [cerca, setCerca] = (0, import_react.useState)(false);
  ...
  const Mano = ({
    ...
    anim,
    origen
  }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("g", { style: { animation: anim, transformOrigin: origen }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "ellipse",
    {
      cx: p.x,
      cy: p.y,
    ...
    "svg",
    {
      ...
      ` }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("radialGradient", { id: `body${id}`, cx: "34%", cy: "28%", r: "78%", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: "#ffffff", stopOpacity: "0.95" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "34%", stopColor: claro }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "76%", stopColor: accent }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: accent })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("radialGradient", { id: `base${id}`, cx: "50%", cy: "88%", r: "52%", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: muyClaro, stopOpacity: "0.9" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: muyClaro, stopOpacity: "0" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("radialGradient", { id: `glow${id}`, cx: "50%", cy: "50%", r: "50%", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "60%", stopColor: accent, stopOpacity: "0.35" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: accent, stopOpacity: "0" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("radialGradient", { id: `hand${id}`, cx: "35%", cy: "30%", r: "75%", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: lighten(accent, 0.65) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: accent })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("clipPath", { id: `clip${id}`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "60", cy: "62", r: "38" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "60", cy: "64", r: "45", fill: `url(#glow${id})` }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "60", cy: "62", r: "38", fill: `url(#body${id})` }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "60", cy: "62", r: "38", fill: `url(#base${id})`, clipPath: `url(#clip${id})` }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ellipse", { cx: "48", cy: "43", rx: "13", ry: "9", fill: "#fff", opacity: "0.55", transform: "rotate(-25 48 43)" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "g",
          {
            ...
            children: ojosFelices ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M41 65 Q49 55 57 65", stroke: "#fff", strokeWidth: "5.5", strokeLinecap: "round", fill: "none" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M63 65 Q71 55 79 65", stroke: "#fff", strokeWidth: "5.5", strokeLinecap: "round", fill: "none" })
            ] }) : dormido ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M41 60 Q49 68 57 60", stroke: "#fff", strokeWidth: "5", strokeLinecap: "round", fill: "none" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M63 60 Q71 68 79 60", stroke: "#fff", strokeWidth: "5", strokeLinecap: "round", fill: "none" })
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: [45, 67].map((x) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "rect",
              {
                x,
                y: 62 - ojoAlto / 2,
        ...
        (comiendo || hablando) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "ellipse",
          {
            cx: "60",
            cy: "82",
        ...
        !comiendo && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mano, { p: manoIzq, anim: animIzq, origen: `${manoIzq.x}px ${manoIzq.y}px` }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mano, { p: manoDer, anim: animDer, origen: `${manoDer.x}px ${manoDer.y}px` })
        ] }),
        comiendo && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "16", cy: "86", r: "4.2", fill: "#fff8e1" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "23", cy: "83", r: "4.8", fill: "#fffdf5" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "30", cy: "86", r: "3.8", fill: "#fff8e1" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M11 88 L15 106 L31 106 L35 88 Z", fill: "#e94b4b" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M18.4 88 L20.6 106 L24.2 106 L22.8 88 Z", fill: "#fff", opacity: "0.95" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M28.5 88 L27 106 L29.6 106 L32 88 Z", fill: "#fff", opacity: "0.95" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "10", y: "86", width: "26", height: "4", rx: "1.6", fill: "#c93b3b" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mano, { p: { x: 14, y: 100, r: 12 }, anim: "none", origen: "14px 100px" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { style: { animation: "agc-eat-hand 1.9s ease-in-out infinite" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ellipse", { cx: "36", cy: "90", rx: "9", ry: "8.5", fill: `url(#hand${id})` }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "circle",
              {
                cx: "38",
        ...
        dormido && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { fill: oscuro, fontWeight: "800", fontFamily: FONT, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "90", y: "36", fontSize: "20", style: { animation: "agc-z 3s ease-out infinite" }, children: "z" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "99", y: "26", fontSize: "15", style: { animation: "agc-z 3s ease-out 1s infinite" }, children: "z" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "106", y: "18", fontSize: "11", style: { animation: "agc-z 3s ease-out 2s infinite" }, children: "z" })
        ] }),
        pensando && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Nube, { id, color: oscuro, contenido: "codigo" }),
        estudiando && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Nube, { id, color: oscuro, contenido: "idea" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M38 100 L60 96 L60 114 L38 118 Z", fill: "#fff" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M82 100 L60 96 L60 114 L82 118 Z", fill: "#f1f1f7" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "path",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M60 96 L60 114", stroke: oscuro, strokeWidth: "1.5", opacity: "0.55" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M43 105 H55 M43 109 H54", stroke: oscuro, strokeWidth: "1.2", opacity: "0.4", strokeLinecap: "round" })
          ] })
        ] })
      ]
    }
...
function Nube({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { style: { animation: "agc-cloud-float 2.6s ease-in-out infinite" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "86", cy: "36", r: "2.6", fill: "#fff", opacity: "0.9" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "93", cy: "28", r: "3.6", fill: "#fff", opacity: "0.95" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ellipse", { cx: "98", cy: "14", rx: "16", ry: "10.5", fill: "#fff" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ellipse", { cx: "86", cy: "17", rx: "8", ry: "6.5", fill: "#fff" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ellipse", { cx: "110", cy: "17", rx: "7.5", ry: "6", fill: "#fff" })
    ] }),
    contenido === "codigo" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { fontFamily: "ui-monospace, monospace", fontSize: "9.5", fontWeight: "700", fill: color, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "98", y: "17.5", textAnchor: "middle", style: { animation: "agc-code-cycle 1.8s steps(1) infinite" }, children: "</>" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "98", y: "17.5", textAnchor: "middle", opacity: "0", style: { animation: "agc-code-cycle 1.8s steps(1) 0.6s infinite" }, children: "{ }" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "98", y: "17.5", textAnchor: "middle", opacity: "0", style: { animation: "agc-code-cycle 1.8s steps(1) 1.2s infinite" }, children: "01" })
    ] }) : (
      /* bombilla de idea */
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { style: { animation: "agc-study-blink 1.8s ease-in-out infinite" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "98", cy: "12", r: "5", fill: "#f5b93c" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "95.6", y: "16.5", width: "4.8", height: "3.4", rx: "1.2", fill: color, opacity: "0.75" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M98 4.5 V1.5 M92 7 L90 5 M104 7 L106 5", stroke: "#f5b93c", strokeWidth: "1.6", strokeLinecap: "round" })
      ] })
    )
  ] });
}
function SparkGlyph({ color = "#363a52" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "path",
    {
...
function AttachGlyph({ color = "#2a2c3a" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "path",
    {
...
function MicGlyph({ pulsing, color = "#2a2c3a" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: "9", y: "2", width: "6", height: "12", rx: "3", stroke: color, strokeWidth: "2" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "path",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `@keyframes agc-pulse{0%,100%{opacity:1}50%{opacity:.4}}` })
      ]
    }
  );
}
function TypingDots() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { display: "inline-flex", gap: 4, padding: "2px 0" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `@keyframes agc-bounce{0%,80%,100%{transform:translateY(0);opacity:.5}40%{transform:translateY(-4px);opacity:1}}` })
  ] });
}
...
function MultiAgentChat({
  ...
  const ruta = (0, import_navigation.usePathname)() || "/";
  const [agentes, setAgentes] = (0, import_react2.useState)(null);
  const [puedeConfigurar, setPuedeConfigurar] = (0, import_react2.useState)(false);
